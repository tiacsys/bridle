...
static int cmd_buzzer_info(const struct shell *sh, size_t argc, char **argv, void *data)
{
	shell_print(sh, "Warning: not yet implemented.");
	return 0;
}

static int cmd_buzzer_beep(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_folksong(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_xmastime(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_funkytown(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_mario(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_golioth(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
static int cmd_buzzer_tiacsys(const struct shell *sh, size_t argc, char **argv, void *data)
{
...
SHELL_STATIC_SUBCMD_SET_CREATE(
	buzzer_play_sub, SHELL_CMD(folksong, NULL, "Play the 'folksong' song", cmd_buzzer_folksong),
	SHELL_CMD(xmastime, NULL, "Play the 'xmastime' song", cmd_buzzer_xmastime),
...
SHELL_STATIC_SUBCMD_SET_CREATE(buzzer_sub,
			       ...
			       SHELL_CMD(play, &buzzer_play_sub, "Play one of predefined sounds",
					 NULL),
			       SHELL_SUBCMD_SET_END);
