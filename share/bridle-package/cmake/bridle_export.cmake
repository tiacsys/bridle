...
# Purpose of this CMake file is to install a BridleConfig package reference in:
# Unix/Linux/MacOS: ~/.cmake/packages/Bridle
# Windows         : HKEY_CURRENT_USER
#
# Having BridleConfig package allows for find_package(Bridle)
# to work when BRIDLE_BASE is not defined. Create the reference
# by running `cmake -P bridle_export.cmake` in this directory.
...
if(WIN32)
  execute_process(
      ...
      "HKEY_CURRENT_USER\\Software\\Kitware\\CMake\\Packages\\Bridle\;${MD5_SUM}"
      "${CMAKE_CURRENT_LIST_DIR}"
  )
else()
  file(WRITE $ENV{HOME}/.cmake/packages/Bridle/${MD5_SUM}
             ${CMAKE_CURRENT_LIST_DIR}
  )
endif()

message("Bridle (${CMAKE_CURRENT_LIST_DIR})")
message("has been added to the user package registry in:")
if(WIN32)
  message("HKEY_CURRENT_USER\\Software\\Kitware\\CMake\\Packages\\Bridle\n")
else()
  message("~/.cmake/packages/Bridle\n")
endif()
