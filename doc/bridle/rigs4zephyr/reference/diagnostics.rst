...
:doc:`/rigs4zephyr/reference/api/index` for what each stage does) and what to check
...
:doc:`/rigs4zephyr/explanation/architecture` explains *why* the pipeline is cut where
...
:doc:`/rigs4zephyr/reference/api/loader` before a board is ever read. A ``phys-*``
...
with nothing left — caught by the :doc:`/rigs4zephyr/reference/api/board` reader or
the :doc:`/rigs4zephyr/reference/api/analyzer` once a real board devicetree is in
...
.. list-table::
   ...
   * - ``lang-addr-authority``
     - :doc:`/rigs4zephyr/reference/api/loader`
   ...
   * - ``lang-promote-opts``
     - :doc:`/rigs4zephyr/reference/api/cli`
...
.. list-table::
   ...
   * - Code
     ...
     - Meaning, and what to check
   * - ``phys-addr``
     - :doc:`/rigs4zephyr/reference/api/analyzer`
   ...
   * - ``phys-board``
     - :doc:`/rigs4zephyr/reference/api/board`
     - Everything about whether the named board can be read at all: no
       board was given (checked by the :doc:`/rigs4zephyr/reference/api/cli` itself,
