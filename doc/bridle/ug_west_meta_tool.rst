...
.. |west wind| replace:: :emphasis:`west wind`
.. _west wind: https://en.wikipedia.org/wiki/West_wind
.. |Zephyrus| replace:: :emphasis:`Zephyrus`
.. _Zephyrus: https://en.wikipedia.org/wiki/Zephyrus
...
For details on west's Python APIs, see :ref:`zephyr:west-apis`.

.. rubric:: Footnotes

.. [#west-repo]

   West is developed in its own `repository`_.
