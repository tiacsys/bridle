...
# add a copy button to all elements that match the following CSS selections:
copybutton_selector = "div[class^=highlight]:not(.no-copybutton) > pre"
...
# Bash			r'\$ '				'$ '
# --------------------	------------------------------	-----------------------
# Zephyr Shell		r'uart:~\$ '			'uart:~$ '
# --------------------	------------------------------	-----------------------
# Zephyr Telnet Shell	r'~\$ '				'~$ '
# ====================	==============================	=======================
#
# only copy the input text
...
# honor line continuation characters
