...
|                   +------------------------------------+------------------------------------------------+
|                   | |bridle:board:mimxrt1060_evk|      | | ``mimxrt1060_evk/mimxrt1062/hyperflash/bbe`` |
|                   |                                    | | ``mimxrt1060_evk/mimxrt1062/qspi/bbe``       |
|                   |                                    | | ``mimxrt1060_evk@C/mimxrt1062/qspi/bbe``     |
...
|                   +------------------------------------+------------------------------------------------+
|                   | |bridle:board:rpi_pico|            | | ``rpi_pico/rp2040/bbe``                      |
|                   |                                    | | ``rpi_pico/rp2040/mcuboot/bbe``              |
...
+-------------------+-----------------------------------------+-----------------------------------------------+
| RP2040            | |bridle:board:cytron_maker_nano_rp2040| | | ``cytron_maker_nano_rp2040``                |
|                   |                                         | | ``cytron_maker_nano_rp2040/rp2040``         |
|                   +-----------------------------------------+-----------------------------------------------+
|                   | |bridle:board:cytron_maker_pi_rp2040|   | | ``cytron_maker_pi_rp2040``                  |
...
+-------------------+-----------------------------------------+-----------------------------------------------+
| RP2350            | |bridle:board:cytron_motion_2350_pro|   | | ``cytron_motion_2350_pro/rp2350a/hazard3``  |
|                   |                                         | | ``cytron_motion_2350_pro/rp2350a/m33``      |
|                   +-----------------------------------------+-----------------------------------------------+
...
|                   +-----------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2350_matrix|  | | ``waveshare_rp2350_matrix/rp2350a/hazard3`` |
