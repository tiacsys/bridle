...
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_eth|      | | ``waveshare_rp2040_eth``                    |
|                   |                                          | | ``waveshare_rp2040_eth/rp2040``             |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_geek|     | | ``waveshare_rp2040_geek``                   |
|                   |                                          | | ``waveshare_rp2040_geek/rp2040``            |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_lcd_0_96| | | ``waveshare_rp2040_lcd_0_96``               |
|                   |                                          | | ``waveshare_rp2040_lcd_0_96/rp2040``        |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_matrix|   | | ``waveshare_rp2040_matrix``                 |
|                   |                                          | | ``waveshare_rp2040_matrix/rp2040``          |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_one|      | | ``waveshare_rp2040_one``                    |
|                   |                                          | | ``waveshare_rp2040_one/rp2040``             |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_plus|     | | ``waveshare_rp2040_plus``                   |
|                   |                                          | | ``waveshare_rp2040_plus/rp2040``            |
|                   |                                          | | ``waveshare_rp2040_plus@16mb``              |
|                   |                                          | | ``waveshare_rp2040_plus@16mb/rp2040``       |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_tiny|     | | ``waveshare_rp2040_tiny``                   |
|                   |                                          | | ``waveshare_rp2040_tiny/rp2040``            |
|                   +------------------------------------------+-----------------------------------------------+
|                   | |bridle:board:waveshare_rp2040_zero|     | | ``waveshare_rp2040_zero``                   |
