.. _bridle_release_notes_423:

|BRIDLE| 4.2.3 Release Notes (Working draft)
############################################
...
* PROJECT UPDATE to `Zephyr Project`_ v4.2.3
...
4. Update all output messages in documentation to be in sync with the upcoming
   Bridle version v4.2.3, based on Zephyr v4.2 (samples and tests).
