.. _bridle_release_notes_373:

|BRIDLE| 3.7.3 Release Notes (Working draft)
############################################
...
* PROJECT UPDATE to `Zephyr Project`_ v3.7.3
...
4. Update all output messages in documentation to be in sync with the upcoming
   Bridle version v3.7.3, based on Zephyr v3.7 (samples and tests).
