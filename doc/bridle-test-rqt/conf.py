...
BRIDLE_WORKD = os.path.join(utils.get_builddir(), 'bridle-test-rqt')
...
project = utils.get_projname('bridle-test-rqt')
...
external_content_contents = [
    (BRIDLE_BASE / 'doc' / 'bridle-test-rqt', '[!_]*'),
]
...
def update_inventory_warnings_filter_config(app):
    ...
    if "warnings_filter_config" in app.config:
        ...
        app.config.warnings_filter_config = os.path.join(
            BRIDLE_BASE, 'doc', 'bridle-test-rqt', 'known-warnings-inventory.txt'
        )
