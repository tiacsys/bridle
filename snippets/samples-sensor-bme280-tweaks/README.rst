...
Unfortunately, the example for the :external+zephyr:zephyr:code-sample:`bme280`
from the Zephyr upstream repository binds such a sensor hard to the SPI bus
regardless of board and shield variations, although the |zephyr:board:rpi_pico|
...
exclusively for the standard :external+zephyr:zephyr:code-sample:`bme280`
sample from Zephyr.
