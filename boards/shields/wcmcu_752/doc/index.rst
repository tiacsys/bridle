...
WCMCU-752 (SC16IS752 Breakout)
##############################

.. toctree::

.. image:: ./img/wcmcu_752.jpg
   :align: center

A breakout kit for the NXP SC16IS752 I2C/SPI to UART/GPIO bridge, providing up
to two outgoing serial connections and up to 8 GPIO pins. The board also
contains a 1.8432 MHz clock rate source for the SC16IS752.

I2C Addressing
==============

The SC16IS752 supports variable I2C addressing through its address select pins
