...
.. tabs::
   ...
   .. group-tab:: Waveshare Pico RGB LED
      ...
      | :hwftlbl-scr:`LED(16×10)` :
        :devicetree:`chosen { zephyr,display = &rgb_led_panel; };`
      | :hwftlbl-led:`16×10 RGB` :
        :devicetree:`&rgb_led_panel { led-strip = <&rgb_led_strip>; };`
      ...
      .. code-block:: console
         ...
         ***** delaying boot 4000ms (per build configuration) *****
         [00:00:00.276,000] <wrn> udc_rpi: BUS RESET
         [00:00:00.356,000] <wrn> udc_rpi: BUS RESET
         *** Booting Zephyr OS … … … (delayed boot 4000ms) ***
         [00:00:04.002,000] <inf> sample: Display sample for rgb-led-panel
