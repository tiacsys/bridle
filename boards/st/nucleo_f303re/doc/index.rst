.. _nucleo_f303re_board-extensions:
...
upstream board |zephyr:board:nucleo_f303re| with some adaptions and
...
- set default entries for ``model`` and ``compatible`` of the boards:
  ...
  .. list-table::
     ...
     * - .. rubric:: ST Nucleo F303RE

     * - .. literalinclude:: ../nucleo_f303re_bbe.dts
            :caption: nucleo_f303re_bbe.dts
            :language: DTS
            :encoding: ISO-8859-1
            :prepend: / {
            :start-at: model
