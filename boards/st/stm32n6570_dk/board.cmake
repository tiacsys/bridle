...
#
# Registers the stm32n6570_dk runner as the default flash runner.  That runner
...
if(CONFIG_STM32N6_BOOT_SERIAL)
  board_runner_args(stm32n6570_dk "--port=usb1")
  board_runner_args(stm32n6570_dk "--download-modifiers=0x1")
  board_runner_args(stm32n6570_dk "--start-modifiers=noack")
else()
  board_runner_args(stm32n6570_dk "--port=swd")
  board_runner_args(stm32n6570_dk "--tool-opt= mode=HOTPLUG ap=1")
  board_runner_args(stm32n6570_dk "--no-reset")
  board_runner_args(stm32n6570_dk "--extload=MX66UW1G45G_STM32N6570-DK.stldr")
  ...
  board_runner_args(stm32n6570_dk "--download-address=${app_base_addr}")
endif()

# Boot pin controller device — can be set via cmake cache variable or env var.
if(DEFINED N6_BOOT_CTRL_DEVICE)
  board_runner_args(stm32n6570_dk "--boot-device=${N6_BOOT_CTRL_DEVICE}")
elseif(DEFINED ENV{N6_BOOT_CTRL_DEVICE})
  board_runner_args(stm32n6570_dk "--boot-device=$ENV{N6_BOOT_CTRL_DEVICE}")
endif()

board_set_flasher(stm32n6570_dk)
board_finalize_runner_args(stm32n6570_dk)
