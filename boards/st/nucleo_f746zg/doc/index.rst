.. _nucleo_f746zg_board-extensions:
...
upstream board |zephyr:board:nucleo_f746zg| with some adaptions and
...
- set default entries for ``model`` and ``compatible`` of the boards:
  ...
  .. list-table::
     ...
     * - .. literalinclude:: ../nucleo_f746zg_bbe.dts
            :caption: nucleo_f746zg_bbe.dts
            :language: DTS
            :encoding: ISO-8859-1
            :prepend: / {
            :start-at: model
