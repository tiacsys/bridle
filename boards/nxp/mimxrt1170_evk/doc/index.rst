.. _mimxrt1170_evk_board-extensions:
...
upstream board |zephyr:board:mimxrt1170_evk| with some adaptions and
...
- :bbl:`activate` self powered USB explicitly and set the maximum of
  ...
  .. list-table::
     ...
     * - .. rubric:: NXP MIMXRT1170-EVK and MIMXRT1170-EVKB
...
- set default entries for ``model`` and ``compatible`` of the boards:
  ...
  .. list-table::
     ...
     * - .. literalinclude:: ../mimxrt1170_evk.dtsi
            :caption: mimxrt1170_evk.dtsi
            :language: DTS
            :encoding: ISO-8859-1
            :prepend: / {
            :start-at: model
