...
# Set CYTRON_RP2040_DEBUG_ADAPTER to select debug adapter by command-line
# arguments, e.g.:
#
#   west build -b cytron_maker_pi_rp2040 \
...
if ("${CYTRON_RP2040_DEBUG_ADAPTER}" STREQUAL "")
	set(CYTRON_RP2040_DEBUG_ADAPTER "cmsis-dap")
endif()

board_runner_args(openocd --cmd-pre-init "source [find interface/${CYTRON_RP2040_DEBUG_ADAPTER}.cfg]")
