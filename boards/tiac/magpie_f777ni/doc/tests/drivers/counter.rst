...
.. tabs::
   ...
   .. group-tab:: Results
      ...
      .. parsed-literal::
         ...
         INFO    - 1/1 magpie_f777ni/stm32f777xx tests/drivers/counter/counter_basic_api/drivers.counter.basic_api :bgn:`PASSED` (device: DT04BNT1, 326.124s <zephyr>)
         ...
         INFO    - :bgn:`1 of 1` executed test configurations passed (100.00%), :bbk:`0` built (not run), :brd:`0` failed, :bbk:`0` errored, with no warnings in :bbk:`360.17 seconds`.
