...
please start with the upstream Zephyr :ref:`zephyr:board_porting_guide`. To add
...
:ref:`choices <zephyr:devicetree-chosen-nodes>` can not be added in the
...
board extensions read the upstream Zephyr :ref:`zephyr:board_porting_guide`,
