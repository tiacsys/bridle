.. _tests-shields-grove-btn-dts-bindings:
...
hours to complete (:bbl:`≈18.50h` for :ibl:`≈195 test scenarios` on
...
be used for maintenance (checks only :bbl:`≈2.60%` of all platforms in about
:bbl:`≈2.30h`):
